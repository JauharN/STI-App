...
import '../sti_text_field_widget.dart';
import 'teacher_selection_widget.dart';
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                STITextField(
                  ...
                  validator: (value) {
                    ...
                    if (!['TAHFIDZ', 'GMM', 'IFIS']
                      ...
                      return 'Nama program harus TAHFIDZ, GMM, atau IFIS';
                    }
                    return null;
                  },
                ),
                ...
                // Teachers selection
                TeacherSelectionWidget(
                  selectedTeacherIds: selectedTeacherIds,
                  selectedTeacherNames: selectedTeacherNames,
                  onTeacherIdsChanged: (ids) =>
                      setState(() => selectedTeacherIds = ids),
                  onTeacherNamesChanged: (names) =>
                      setState(() => selectedTeacherNames = names),
                ),
                verticalSpace(24),
          ...
          data: (teachers) => Wrap(
            ...
            children: teachers.map((teacher) {
              ...
              return FilterChip(
                ...
                onSelected: (selected) {
                  // Validate max teachers
                  if (selected && selectedTeacherIds.length >= 3) {
                    context
                        .showErrorSnackBar('Maksimal 3 pengajar per program');
                    return;
                  }
