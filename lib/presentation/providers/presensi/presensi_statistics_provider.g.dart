...
String _$presensiStatisticsHash() =>
    r'f81303218ffa7a299326a031d2d92766d9adba92';
...
/// See also [PresensiStatistics].
class PresensiStatisticsFamily extends Family<AsyncValue<void>> {
  /// See also [PresensiStatistics].
...
/// See also [PresensiStatistics].
class PresensiStatisticsProvider
    extends AutoDisposeAsyncNotifierProviderImpl<PresensiStatistics, void> {
  /// See also [PresensiStatistics].
  ...
  @override
  AutoDisposeAsyncNotifierProviderElement<PresensiStatistics, void>
      createElement() {
...
mixin PresensiStatisticsRef on AutoDisposeAsyncNotifierProviderRef<void> {
  /// The parameter `programId` of this provider.
  String get programId;
}

class _PresensiStatisticsProviderElement
    extends AutoDisposeAsyncNotifierProviderElement<PresensiStatistics, void>
    with PresensiStatisticsRef {
